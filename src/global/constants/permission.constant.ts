...
export const permissionData: Array<{
  ...
  {
    key: PERMISSIONS.change_password,
    module: 'auth',
    title: 'Change Password',
  },
  {
    key: PERMISSIONS.update_phone_number,
    module: 'auth',
  ...
  {
    key: PERMISSIONS.create_nested_user,
    module: 'auth',
    title: 'Create Nested User',
  },
  { key: PERMISSIONS.find_users_crm, module: 'auth', title: 'Find Users CRM' },
  {
    key: PERMISSIONS.update_users_crm,
    module: 'auth',
    title: 'Update Users CRM',
  },
  ...
  // Warehouse permissions
  {
    key: PERMISSIONS.create_warehouse,
    module: 'warehouse',
    title: 'Create Warehouse',
  },
  {
    key: PERMISSIONS.read_warehouse,
    module: 'warehouse',
    title: 'Read Warehouse',
  },
  {
    key: PERMISSIONS.update_warehouse,
    module: 'warehouse',
    title: 'Update Warehouse',
  },
  {
    key: PERMISSIONS.delete_warehouse,
    module: 'warehouse',
  ...
  // Perfumer permissions
  {
    key: PERMISSIONS.create_perfumer,
    module: 'perfumer',
    title: 'Create Perfumer',
  },
  {
    key: PERMISSIONS.read_perfumer,
    module: 'perfumer',
    title: 'Read Perfumer',
  },
  {
    key: PERMISSIONS.update_perfumer,
    module: 'perfumer',
    title: 'Update Perfumer',
  },
  {
    key: PERMISSIONS.delete_perfumer,
    module: 'perfumer',
  ...
  // Promocode permissions
  {
    key: PERMISSIONS.create_promocode,
    module: 'promocode',
    title: 'Create Promocode',
  },
  {
    key: PERMISSIONS.update_promocode,
    module: 'promocode',
    title: 'Update Promocode',
  },
  {
    key: PERMISSIONS.delete_promocode,
    module: 'promocode',
    title: 'Delete Promocode',
  },
  {
    key: PERMISSIONS.find_promocodes,
    module: 'promocode',
    title: 'Find Promocodes',
  },
  {
    key: PERMISSIONS.find_active_promocodes,
    module: 'promocode',
    title: 'Find Active Promocodes',
  },
  {
    key: PERMISSIONS.validate_promocode,
    module: 'promocode',
    title: 'Validate Promocode',
  },
  {
    key: PERMISSIONS.use_promocode,
    module: 'promocode',
    title: 'Use Promocode',
  },
  {
  ...
  // Contract permissions
  {
    key: PERMISSIONS.create_contract,
    module: 'contract',
    title: 'Create Contract',
  },
  {
    key: PERMISSIONS.read_contract,
    module: 'contract',
    title: 'Read Contract',
  },
  {
    key: PERMISSIONS.update_contract,
    module: 'contract',
    title: 'Update Contract',
  },
  {
    key: PERMISSIONS.delete_contract,
    module: 'contract',
    title: 'Delete Contract',
  },
  {
    key: PERMISSIONS.record_payment,
    module: 'contract',
    title: 'Record Payment',
  },
  {
    key: PERMISSIONS.update_contract_status,
    module: 'contract',
    title: 'Update Contract Status',
  },
  {
    key: PERMISSIONS.read_my_contracts,
    module: 'contract',
    title: 'Read logged user contracts',
  },
  {
    key: PERMISSIONS.approve_contract,
    module: 'contract',
    title: 'Approve Contract',
  },
  {
    key: PERMISSIONS.cancel_contract,
    module: 'contract',
    title: 'Cancel Contract',
  },
  {
    key: PERMISSIONS.complete_contract,
    module: 'contract',
  ...
  {
    key: PERMISSIONS.create_order_item,
    module: 'order',
    title: 'Create Order Item',
  },
  {
    key: PERMISSIONS.read_order_item,
    module: 'order',
    title: 'Read Order Item',
  },
  {
    key: PERMISSIONS.update_order_item,
    module: 'order',
    title: 'Update Order Item',
  },
  {
    key: PERMISSIONS.delete_order_item,
    module: 'order',
    title: 'Delete Order Item',
  },
  {
    key: PERMISSIONS.create_order_status,
    module: 'order',
    title: 'Create Order Status',
  },
  {
    key: PERMISSIONS.read_order_status,
    module: 'order',
  ...
  {
    key: PERMISSIONS.delete_order_status,
    module: 'order',
    title: 'Delete Order Status',
  },
  {
    key: PERMISSIONS.create_order_payment,
    module: 'order',
    title: 'Create Order Payment',
  },
  {
    key: PERMISSIONS.read_order_payment,
    module: 'order',
    title: 'Read Order Payment',
  },
  {
    key: PERMISSIONS.update_order_payment,
    module: 'order',
    title: 'Update Order Payment',
  },
  {
    key: PERMISSIONS.delete_order_payment,
    module: 'order',
  ...
  // Payment permissions
  {
    key: PERMISSIONS.create_payment,
    module: 'payment',
    title: 'Create Payment',
  },
  { key: PERMISSIONS.read_payment, module: 'payment', title: 'Read Payment' },
  {
    key: PERMISSIONS.update_payment,
    module: 'payment',
    title: 'Update Payment',
  },
  {
    key: PERMISSIONS.delete_payment,
    module: 'payment',
  ...
  {
    key: PERMISSIONS.update_invoice,
    module: 'invoice',
  ...
  // Report permissions
  {
    key: PERMISSIONS.generate_report,
    module: 'report',
  ...
  {
    key: PERMISSIONS.read_notification,
    module: 'notification',
  ...
  {
    key: PERMISSIONS.create_email_queue,
    module: 'email_queue',
    title: 'Create Email Queue',
  },
  { key: PERMISSIONS.send_email, module: 'email_queue', title: 'Send Email' },
  {
    key: PERMISSIONS.read_email_queue,
    module: 'email_queue',
    title: 'Read Email Queue',
  },
  {
    key: PERMISSIONS.remove_email_job,
    module: 'email_queue',
    title: 'Remove Email Job',
  },
  {
    key: PERMISSIONS.pause_email_queue,
    module: 'email_queue',
    title: 'Pause Email Queue',
  },
  {
    key: PERMISSIONS.resume_email_queue,
    module: 'email_queue',
    title: 'Resume Email Queue',
  },
  {
    key: PERMISSIONS.clean_email_queue,
    module: 'email_queue',
    title: 'Clean Email Queue',
  },

  // Audit logger permissions
  { key: PERMISSIONS.audit_logs, module: 'audit_logger', title: 'Audit Logs' },
  {
    key: PERMISSIONS.read_audit_logs,
    module: 'audit_logger',
  ...
  // Measurement permissions
  {
    key: PERMISSIONS.create_measurement,
    module: 'measurement',
    title: 'Create Measurement',
  },
  {
    key: PERMISSIONS.read_measurement,
    module: 'measurement',
    title: 'Read Measurement',
  },
  {
    key: PERMISSIONS.update_measurement,
    module: 'measurement',
    title: 'Update Measurement',
  },
  {
    key: PERMISSIONS.delete_measurement,
    module: 'measurement',
  ...
  // Material permissions
  {
    key: PERMISSIONS.create_material,
    module: 'material',
    title: 'Create Material',
  },
  {
    key: PERMISSIONS.read_material,
    module: 'material',
    title: 'Read Material',
  },
  {
    key: PERMISSIONS.update_material,
    module: 'material',
    title: 'Update Material',
  },
  {
    key: PERMISSIONS.delete_material,
    module: 'material',
  ...
  // Scent note permissions
  {
    key: PERMISSIONS.create_scent_note,
    module: 'scent_note',
    title: 'Create Scent Note',
  },
  {
    key: PERMISSIONS.read_scent_note,
    module: 'scent_note',
    title: 'Read Scent Note',
  },
  {
    key: PERMISSIONS.update_scent_note,
    module: 'scent_note',
    title: 'Update Scent Note',
  },
  {
    key: PERMISSIONS.delete_scent_note,
    module: 'scent_note',
  ...
  // Attachment permissions
  {
    key: PERMISSIONS.create_attachment,
    module: 'attachment',
    title: 'Create Attachment',
  },
  {
    key: PERMISSIONS.upload_attachment,
    module: 'attachment',
    title: 'Upload Attachment',
  },
  {
    key: PERMISSIONS.read_attachment,
    module: 'attachment',
    title: 'Read Attachment',
  },
  {
    key: PERMISSIONS.update_attachment,
    module: 'attachment',
    title: 'Update Attachment',
  },
  {
    key: PERMISSIONS.delete_attachment,
    module: 'attachment',
  ...
  {
    key: PERMISSIONS.bulk_delete_salary,
    module: 'salary',
    title: 'Bulk Delete Salary',
  },
  {
    key: PERMISSIONS.read_my_salary,
    module: 'salary',
    title: 'Read My Salary',
  },

  // Salary taxes permissions
  {
    key: PERMISSIONS.create_salary_taxes,
    module: 'salary_taxes',
    title: 'Create Salary Taxes',
  },
  {
    key: PERMISSIONS.read_salary_taxes,
    module: 'salary_taxes',
    title: 'Read Salary Taxes',
  },
  {
    key: PERMISSIONS.update_salary_taxes,
    module: 'salary_taxes',
    title: 'Update Salary Taxes',
  },
  {
    key: PERMISSIONS.delete_salary_taxes,
    module: 'salary_taxes',
    title: 'Delete Salary Taxes',
  },
  {
  ...
  {
    key: PERMISSIONS.assign_salary_taxes,
    module: 'salary_taxes',
    title: 'Assign Salary Taxes',
  },
  {
    key: PERMISSIONS.read_my_salary_taxes,
    module: 'salary_taxes',
    title: 'Read My Salary Taxes',
  },
  ...
  {
    key: PERMISSIONS.read_salary_history,
    module: 'salary_history',
    title: 'Read Salary History',
  },
  {
  ...
  // Invoice taxes permissions
  {
    key: PERMISSIONS.create_invoice_taxes,
    module: 'invoice_taxes',
    title: 'Create Invoice Taxes',
  },
  {
    key: PERMISSIONS.read_invoice_taxes,
    module: 'invoice_taxes',
    title: 'Read Invoice Taxes',
  },
  {
    key: PERMISSIONS.update_invoice_taxes,
    module: 'invoice_taxes',
    title: 'Update Invoice Taxes',
  },
  {
    key: PERMISSIONS.delete_invoice_taxes,
    module: 'invoice_taxes',
    title: 'Delete Invoice Taxes',
  },
  ...
  // User group permissions
  {
    key: PERMISSIONS.create_user_group,
    module: 'user_group',
    title: 'Create User Group',
  },
  {
    key: PERMISSIONS.read_user_group,
    module: 'user_group',
    title: 'Read User Group',
  },
  {
    key: PERMISSIONS.update_user_group,
    module: 'user_group',
    title: 'Update User Group',
  },
  {
    key: PERMISSIONS.delete_user_group,
    module: 'user_group',
    title: 'Delete User Group',
  },
  {
    key: PERMISSIONS.assign_users_to_group,
    module: 'user_group',
  ...
  // Permissions
  {
    key: PERMISSIONS.read_permissions,
    module: 'permissions',
  ...
  {
    key: PERMISSIONS.mark_alert_as_acknowledged,
    module: 'alert',
  ...
  {
    key: PERMISSIONS.remove_member,
    module: 'job_hierarchy',
    title: 'Remove Member',
  },
  {
    key: PERMISSIONS.reorder_member,
    module: 'job_hierarchy',
    title: 'Reorder Member',
  },
  {
    key: PERMISSIONS.move_member,
    module: 'job_hierarchy',
    title: 'Move Member',
  },
  {
    key: PERMISSIONS.replace_user,
    module: 'job_hierarchy',
    title: 'Replace User',
  },
  {
    key: PERMISSIONS.replace_hierarchy,
    module: 'job_hierarchy',
    title: 'Replace Hierarchy',
  },
  {
    key: PERMISSIONS.read_hierarchy,
    module: 'job_hierarchy',
  ...
  // Complaint permissions
  {
    key: PERMISSIONS.read_complaint,
    module: 'complaint',
    title: 'Read Complaint',
  },
  {
    key: PERMISSIONS.create_complaint,
    module: 'complaint',
    title: 'Create Complaint',
  },
  {
    key: PERMISSIONS.update_complaint,
    module: 'complaint',
    title: 'Update Complaint',
  },
  {
    key: PERMISSIONS.delete_complaint,
    module: 'complaint',
    title: 'Delete Complaint',
  },
  {
    key: PERMISSIONS.accept_complaint,
    module: 'complaint',
  ...
  {
    key: PERMISSIONS.read_complaint_note,
    module: 'complaint_note',
    title: 'Read Complaint Note',
  },
  {
  ...
  {
    key: PERMISSIONS.create_comment,
    module: 'comment',
    title: 'Create Comment',
  },
  {
    key: PERMISSIONS.update_comment,
    module: 'comment',
    title: 'Update Comment',
  },
  {
    key: PERMISSIONS.delete_comment,
    module: 'comment',
  ...
  // Blocked Users permissions
  {
    key: PERMISSIONS.read_blocked_users,
    module: 'blocked_users',
    title: 'Read Blocked Users',
  },
  {
    key: PERMISSIONS.toggle_block_users,
    module: 'blocked_users',
    title: 'Toggle Block Users',
  },
  ...
  {
    key: PERMISSIONS.update_task_status,
    module: 'task',
    title: 'Update Task Status',
  },
  {
    key: PERMISSIONS.manage_task_status,
    module: 'task_status',
    title: 'Manage Task Status',
  },
  {
    key: PERMISSIONS.read_task_status,
    module: 'task_status',
    title: 'Read Task Status',
  },
  {
    key: PERMISSIONS.create_task_comment,
    module: 'task_comment',
    title: 'Create Task Comment',
  },
  {
    key: PERMISSIONS.read_task_comment,
    module: 'task_comment',
    title: 'Read Task Comment',
  },
  {
    key: PERMISSIONS.update_task_comment,
    module: 'task_comment',
    title: 'Update Task Comment',
  },
  {
    key: PERMISSIONS.delete_task_comment,
    module: 'task_comment',
    title: 'Delete Task Comment',
  },
  {
    key: PERMISSIONS.manage_task_watchers,
    module: 'task_watchers',
  ...
  {
    key: PERMISSIONS.find_published_blog,
    module: 'blog',
    title: 'Find Published Blog',
  },

  // blog category
  {
    key: PERMISSIONS.create_blog_category,
    module: 'blog_category',
    title: 'Create Blog Category',
  },
  {
    key: PERMISSIONS.find_blog_category,
    module: 'blog_category',
    title: 'Read Blog Category',
  },
  {
    key: PERMISSIONS.update_blog_category,
    module: 'blog_category',
    title: 'Update Blog Category',
  },
  {
    key: PERMISSIONS.remove_blog_category,
    module: 'blog_category',
    title: 'Remove Blog Category',
  },
  {
    key: PERMISSIONS.find_blog_category,
    module: 'blog_category',
    title: 'Find Blog Category',
  },
  // Cart permissions
  { key: PERMISSIONS.add_to_cart, module: 'cart', title: 'Add to Cart' },
  {
    key: PERMISSIONS.remove_from_cart,
    module: 'cart',
    title: 'Remove from Cart',
  },
  {
    key: PERMISSIONS.update_cart_item,
    module: 'cart',
